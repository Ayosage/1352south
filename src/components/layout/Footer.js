    ...
    <footer className="bg-black text-white py-16 border-t border-neutral-800">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <div>
            <div className="text-white text-3xl font-light tracking-widest mb-6 block">
              <span>1352</span> <span className="text-amber-400">LOFTS</span>
            </div>
            <p className="text-gray-400 mt-4 font-light w-1/2">
          ...
          <div>
            ...
            <address className="not-italic text-gray-400 font-light">
              ...
              <p className="mb-3">info@1352lofts.com</p>
        ...
        <div className="border-t border-neutral-800 mt-16 pt-8 text-center">
          <p className="text-gray-500 text-sm font-light">
            &copy; {new Date().getFullYear()} 1352 Lofts. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
